...
from ..tools import (get_install_names, set_install_name, check_call)
...
def _make_libtree(out_path):
    ...
    assert_raises(RuntimeError, check_call, [test_lib])
    assert_raises(RuntimeError, check_call, [stest_lib])
